    ...
    <div id="about">
      ...
      <div id="about" className="BG lg:hidden bg-white py-[5rem]">
        <div className=" text-center items-center flex flex-col">
          ...
          <h5 className="uppercase font-semibold mt-[2rem] mb-[1rem] text-[#147efb]">
            About me
          </h5>
          <h3 className="text-2xl sm:text-3xl max-w-xs sm:max-w-lg font-medium">
            A dedicated Front-end Developer based in Basra, Iraq 📍
          </h3>
          <p className="text-[#767676] sm:text-xl mt-[2rem] max-w-xs sm:max-w-lg">
